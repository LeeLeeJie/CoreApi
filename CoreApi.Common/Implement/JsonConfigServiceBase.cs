...
using System.IO;
using System.Text;
using CoreApi.Common.ICommonService;
using CoreApi.Common.Tools;

namespace CoreApi.Common.Implement
{
    public abstract class JsonConfigServiceBase<TConfig> : IJsonConfigService<TConfig>
        where TConfig : IConfig, new()
    {
        ...
        protected JsonConfigServiceBase(ILogService logService, IJsonSerializer jsonSerializer)
        {
